    ...
    module: {
      rules: [
        ...
        },
        {
          ...
          exclude: /((oneone|layers|layers-2x|marker-icon|marker-icon-2x|marker-shadow|map-fake)\.png)|(cover\.jpg)/,
          use: [
            {
              loader: "url-loader",
              options: {
        ...
        {
          test: /((oneone|layers|layers-2x|marker-icon|marker-icon-2x|marker-shadow|map-fake)\.png)|(cover\.jpg)/,
          use: {
            loader: "file-loader",
            options: {
